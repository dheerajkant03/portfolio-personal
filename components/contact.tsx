...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 px-4 md:px-8 lg:px-16 bg-muted/30">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">dheeraj22161@iiitd.ac.in</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">8171362203</p>
                    </div>
                  </div>
                </div>
